...
<head>
    ...
    <title>F.A.Q. - Ace In The Hole Multisport Events</title>
...
<main>
    ...
    <dl>
        ...
        <dt>What are the Rules for the upcoming event?</dt>
        <dd>
        ...
        <dd>
            ...
            <ul>
            <li>Swim: Wetsuits are optional for the swim but will provide buoyancy and warmth. However, many people opt for no wetsuit for a triathlon so no worries. We will provide you with a swim cap but you will want to bring your own goggles.</li>
        ...
        <dt>What is the cost of each event?</dt>
        <dd>
            <p>Long Course - $240</p>
            <p>Olympic - $110</p>
            <p>10K - $50</p>
            ...
            <p>Sprint - $90</p>
            <p>Try-a-Tri - $65</p>
            <p>Splash n' Dash (ages 4-15) - $25, Free with an Adult event registration</p>
        </dd>

        <dt>What does the registration cost include?</dt>
        <dd>
            <p>Food & Beer</p>
        ...
        <dt>What are the details of each course/event?</dt>
        <dd>
            <ul>
                ...
                <li>OLYMPIC RUN - 10K - A mostly flat loop course on widely paved bike paths that traverse through and around this beautiful and scenic destination resort (one hill total with a minimal elevation gain).</li>
                <li>Sprint: Course will offer a 1-loop 1/2 mile swim, the exact same 28 mile Bike Course as the Olympic distance and a 5km run.</li>
                <li>Try-A-Tri: This novice race is designed for the first time triathlete, those new to the sport, our Junior Triathletes. The swim is a shorter, more manageable 1/4 mile distance, (instead of the standard 1/2-mile Sprint distance swim), 10 mile bike ride (vs 12 miles and it's a 2 loop course making it very spectator friendly!) and a flat 2 mile run (vs 3 mile sprint course).</li>
                <li>Half Marathon COURSE: Half-Marathon (13.1-miles): Half-Marathon event starts and finishes in the Athletes Village to the cheers of the enthusiastic crowd. Once finished, runners can enjoy the finish line festivities, including the Sports & Fitness Expo and live entertainment. Post-race refreshments will be provided and the Awards Ceremony for the Half-Marathon will begin once the results have been certified</li>
                <li>10k COURSE: The 10K event starts and finishes in the Athletes Village. The paths are approximately 6 ft wide, perfectly paved and wind around through the forest. Each course has only two small hills with a minimal elevation gain to navigate and a fast downhill to flat finish to the roaring cheers of the crowd.</li>
                <li>Splash n' Dash: Kids event for participants ages 4 to 15. This is a 100 yard swim and a 50 yard dash. It is free if an adult registers for an event otherwise it is $25.</li>
            </ul>
        </dd>

        <dt>How do I get in touch with Ace in the Hole?</dt>
        <dd>
            <p>Please <a href="contact.php">CONTACT</a> us with further questions or comments! </p>
        </dd>
